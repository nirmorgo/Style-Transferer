...
def load_vgg_model(path, img=None):
    """
    ...
    if img == None:
        ...
        graph['input'] = tf.placeholder(tf.float32, shape=[None,None,None,3],name='input_img')
    else: 
        graph['input'] = img
...
#%%
#IMAGE_HEIGHT, IMAGE_WIDTH, COLOR_CHANNELS = 680, 680, 3
#OUTPUT_DIR = 'output/'
#model = load_vgg_model(VGG_MODEL)
#print(model)
#CONTENT_LAYER = ('conv4_2',1)   #Name of the layer + cost weight
#STYLE_LAYERS = [
#    ('conv1_1', 0.5),
#    ('conv2_1', 1.0),
#    ('conv3_1', 1.5),
